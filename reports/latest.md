...
_Generated 2026-09-25T10:37:08+00:00 · instrument: **COMEX gold futures (GC/MGC)** · capital: 10,000_
...
## Market snapshot
- Last price: **4,341.60** (2026-09-25)
- 1m / 1y return: -6.9% / 15.1%
- Drawdown from high: -18.4%
...
Blend weights (rolling out-of-sample QLIKE): EWMA 0.31 / GARCH 0.35 / HAR 0.34.
Bootstrap 5-95% band on the blend: 12.8% – 31.1%.
...
- Macro: **hostile** (score -0.51; components: real_yield_trend -1.00, dollar_trend -0.14, risk_aversion -0.38)

## Signal
- Ensemble score: **+0.04** → **FLAT**
- Components: mom_3m +0.67, mom_6m +0.11, mom_12m +0.94, trend_50_200 -1.00, mean_reversion +0.17, macro_regime -0.51, cross_asset +0.09

## Cross-asset picture
- Confirmation score: **+0.09** (components: silver_momentum -0.14, gold_silver_ratio +0.03, miners_leadership +0.58, dollar_headwind -0.12)
- Gold/silver ratio z-score (1y): -0.08 (positive = gold rich vs silver)
- Miners (GDX) 6m momentum vs gold: 10.0%
...
- Binding caps: fractional_kelly=1.59, vol_target=0.79, instrument_max=20.00, global_max=3.00, drawdown_multiplier=0.08, signal_conviction=0.04
...
|---|---|---|---|---|---|
| 0.5x | 5.6% | 24.6% | 0.0% | 0.0% | -7.7% |
| 1.0x | 10.5% | 27.0% | 0.1% | 0.0% | -14.9% |
| 1.5x | 12.4% | 31.2% | 0.5% | 0.0% | -22.1% |
| 2.0x | 13.4% | 34.6% | 4.5% | 0.0% | -28.8% |
| 2.5x | 14.0% | 36.9% | 11.3% | 0.0% | -35.1% |
| 3.0x | 13.3% | 39.5% | 23.9% | 0.0% | -40.9% |
| 4.0x | 10.4% | 44.8% | 50.4% | 0.1% | -51.2% |
| 5.0x | 3.4% | 48.1% | 71.7% | 0.8% | -60.0% |

...
_Generated 2026-09-21T11:09:50+00:00 · instrument: **COMEX gold futures (GC/MGC)** · capital: 10,000_
...
## Market snapshot
- Last price: **4,384.70** (2026-09-21)
- 1m / 1y return: -6.3% / 18.3%
...
Blend weights (rolling out-of-sample QLIKE): EWMA 0.39 / GARCH 0.33 / HAR 0.28.
Bootstrap 5-95% band on the blend: 12.8% – 31.7%.
...
- Macro: **hostile** (score -0.45; components: real_yield_trend -0.81, dollar_trend -0.17, risk_aversion -0.38)

## Signal
- Ensemble score: **-0.09** → **FLAT**
- Components: mom_3m +0.34, mom_6m -0.45, mom_12m +0.95, trend_50_200 -1.00, mean_reversion +0.10, macro_regime -0.45, cross_asset +0.10

## Cross-asset picture
- Confirmation score: **+0.10** (components: silver_momentum -0.61, gold_silver_ratio +0.06, miners_leadership +0.90, dollar_headwind +0.04)
- Gold/silver ratio z-score (1y): -0.17 (positive = gold rich vs silver)
- Miners (GDX) 6m momentum vs gold: 22.0%
...
### → **0.00x FLAT**
- Full Kelly: 2.90x — recommendation uses fractional Kelly ∧ vol-target ∧ drawdown governor ∧ conviction scaling
- Expected log growth at recommendation: 4.0%/yr
- Binding caps: fractional_kelly=1.45, vol_target=0.75, instrument_max=20.00, global_max=3.00, drawdown_multiplier=0.12, signal_conviction=0.09

## Monte Carlo (2000 block-bootstrap paths, 252d, 0.01x)
- Terminal wealth p5/p50/p95: 1.00x / 1.00x / 1.00x
- P(loss) 23.9% · P(DD>25%) 0.0% · P(DD>50%) 0.0% · **P(ruin) 0.0%**
- Expected max drawdown: -0.2%

## Leverage sweep (empirical Kelly curve)
| Lev | median growth/yr | P(loss) | P(DD>50%) | P(ruin) | E[maxDD] |
|---|---|---|---|---|---|
| 0.5x | 5.8% | 24.9% | 0.0% | 0.0% | -7.7% |
| 1.0x | 10.9% | 26.4% | 0.0% | 0.0% | -14.9% |
| 1.5x | 13.2% | 30.4% | 0.7% | 0.0% | -22.1% |
| 2.0x | 14.7% | 33.4% | 4.3% | 0.0% | -28.8% |
| 2.5x | 15.3% | 36.1% | 12.4% | 0.0% | -35.0% |
| 3.0x | 14.8% | 38.4% | 24.3% | 0.0% | -40.8% |
| 4.0x | 11.7% | 43.4% | 49.4% | 0.1% | -51.1% |
| 5.0x | 5.3% | 47.2% | 70.6% | 0.7% | -59.9% |

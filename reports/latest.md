...
_Generated 2026-09-07T10:46:55+00:00 · instrument: **COMEX gold futures (GC/MGC)** · capital: 10,000_
...
## Market snapshot
- Last price: **4,476.60** (2026-09-07)
- 1m / 1y return: 2.6% / 23.0%
- Drawdown from high: -15.8%
...
## Regime
- Statistical (HMM): **turbulent** (typical duration ~25 days)
- Macro: **hostile** (score -0.45; components: real_yield_trend -0.86, dollar_trend -0.02, risk_aversion -0.46)

## Signal
- Ensemble score: **-0.21** → **SHORT**
- Components: mom_3m +0.22, mom_6m -0.86, mom_12m +0.98, trend_50_200 -1.00, mean_reversion -0.17, macro_regime -0.45, cross_asset -0.08

## Cross-asset picture
- Confirmation score: **-0.08** (components: silver_momentum -0.94, gold_silver_ratio +0.03, miners_leadership +0.64, dollar_headwind -0.05)
...
### → **0.03x SHORT**
- Full Kelly: 2.16x — recommendation uses fractional Kelly ∧ vol-target ∧ drawdown governor ∧ conviction scaling
- Expected log growth at recommendation: 4.1%/yr
- Binding caps: fractional_kelly=1.08, vol_target=0.63, instrument_max=20.00, global_max=3.00, drawdown_multiplier=0.21, signal_conviction=0.21
...
| 1.5x | 12.6% | 29.1% | 0.4% | 0.0% | -22.1% |
| 2.0x | 13.6% | 32.4% | 4.3% | 0.0% | -28.8% |
| 2.5x | 13.9% | 35.2% | 12.8% | 0.0% | -35.0% |
| 3.0x | 13.6% | 38.2% | 24.2% | 0.0% | -40.8% |
| 4.0x | 11.0% | 42.4% | 50.1% | 0.0% | -51.1% |
| 5.0x | 4.5% | 47.9% | 70.8% | 0.4% | -59.8% |
